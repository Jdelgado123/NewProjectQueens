      ...
      {products.map((product, index) => (
        <div key={index} className="border border-solid border-blue-700/100 max-w-sm bg-white rounded-lg shadow-xl">
          ...
          <div className="items-center grid grid-cols-2 gap-2 sm:grids-cols-1 md:gap-3">
            ...
            <div className='cart-main content-end flex justify-end pr-3 md:pr-1 sm:pl-8 pb-4  '>
              <Link href={"/succes"}>
                <a href="#" className="cart-main text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center md:text-red"><AiOutlineShoppingCart></AiOutlineShoppingCart></a>
              </Link>
            </div>
          </div>
        </div>
