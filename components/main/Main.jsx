        ...
        <div key={index} className="border border-solid border-blue-700/100 max-w-sm bg-white rounded-lg shadow-xl">
          ...
          <div className="items-center grid grid-flow-col gap-4">
            <div className='content-start text-start justify-start'>
              <span className="pl-2 text-6xl font-bold text-red-600/100 pb-2">{product.currency=="USD"?"$":"S/."}<span className='text-6xl font-bold text-red-600/100 dark:text-black pb-2'>{product.price}</span></span>
            </div>  
