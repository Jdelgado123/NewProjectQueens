...
function CreateNewPublic() {
  ...
  const create = async(e) =>{
    ...
    await axios.post(`/api/pruebamulters`,fd,config)
    ...
    <div className='grid place-items-center'>
            <div className='w-full max-w-xs'>
                <form onSubmit={create} id='formPost' className="bg-white dark:bg-gray-800 shadow-md rounded px-8 pt-6 pb-8 mb-4 grid gap-1">
                    ...
                    <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline dark:bg-gray-600 dark:border-slate-900 dark:text-white" id="title" type="text" name='title' required />
