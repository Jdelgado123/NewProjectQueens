            ...
            {ofertas.map((product, index) => (
                <div key={index} className="max-w-sm bg-white shadow-xl">
                    ...
                    <div className='relative overflow-hidden'>
                        ...
                        {(product.price_offer>0) ? <div className='absolute bottom-0 -mr-12 mb-4 rounded-br-lg right-0 bg-green-500 border-solid border-1 -rotate-45 whitespace-nowrap px-4 text-sm md:text-base w-36 md:w-40 h-6 md:h-8 text-center text-white'>OFERTA</div> : null}
                    </div>
